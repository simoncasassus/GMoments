...
def addprofile(ax, hducubeobs, hducubemod, label, xoffset=0.05, yoffset=0.2, VisibleXaxis=True, VisibleYaxis=True, restfreq=230.5380000*1E9,speccolor='black',specoffset=0.,legendlabel=''):
    ...
    ax.step(vs,specobs+specoffset,color=speccolor,linewidth=0.7,linestyle='solid',label=legendlabel,where='mid')
...
alloffsets=[ [0.21,0.02], [0.13,0.11]]  # extraction point in arcsecs, y, 

 

workdir='/home/simon/HD100546_guvmem_2021red/C6/lines/guvmem_runs/DMoments/12CO_dgaussmoments_2022/'

inputcubefiles = ['/home/simon/HD100546_guvmem_2021red/C6/lines/guvmem_runs/restored_cube_lS0.001_lL0.0_nogrid_kepmask_dV0500_adjust3_robust1.0_z_Resamp.fits']

obscube=inputcubefiles[0]

modelcube=workdir+'modelcube.fits'
...
(clevs,clabels)=addimage(fig_ax2,label,atitle,filename_grey,filename_contours=filename_contours,filename_errormap=filename_errormap, filename_fiterrormap=filename_fiterrormap,VisibleXaxis=True,VisibleYaxis=True,DoBeamEllipse=True,DoGreyCont=False,vsyst=vsyst,SymmetricRange=False,DoCB=True, cmap=cmap,scaleim=1.,cbfmt='%.1f',cbunits=r'$\rm{km}\,\rm{s}^{-1}$',Zoom=True,markers=alloffsets,MedfiltGrey=True)
